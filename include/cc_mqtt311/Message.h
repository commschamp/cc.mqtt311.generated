...
struct MessageFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return cc_mqtt311::MessageFieldsCommon::FlagsMembersCommon::RetainCommon::bitName(idx);
            }
        ...
        class Dup : public
            comms::field::BitmaskValue<
                cc_mqtt311::field::FieldBase<>,
                comms::option::def::HasName,
                comms::option::def::FixedBitLength<5>,
                comms::option::def::BitmaskReservedBits<0x1E, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_mqtt311::MessageFieldsCommon::FlagsMembersCommon::DupCommon::bitName(idx);
            }
