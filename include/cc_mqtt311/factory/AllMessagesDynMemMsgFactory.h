...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            ...
            case 2 /* 0x2 */: return MsgPtr(new cc_mqtt311::message::Connack<TInterface, TProtOptions>);
            ...
            case 9 /* 0x9 */: return MsgPtr(new cc_mqtt311::message::Suback<TInterface, TProtOptions>);
            case 10 /* 0xa */: return MsgPtr(new cc_mqtt311::message::Unsubscribe<TInterface, TProtOptions>);
            case 11 /* 0xb */: return MsgPtr(new cc_mqtt311::message::Unsuback<TInterface, TProtOptions>);
            case 12 /* 0xc */: return MsgPtr(new cc_mqtt311::message::Pingreq<TInterface, TProtOptions>);
            case 13 /* 0xd */: return MsgPtr(new cc_mqtt311::message::Pingresp<TInterface, TProtOptions>);
