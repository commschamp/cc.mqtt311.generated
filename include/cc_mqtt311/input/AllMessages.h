...
#define CC_MQTT311_ALIASES_FOR_ALL_MESSAGES(prefix_, suffix_, interface_, opts_) \
...
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define CC_MQTT311_ALIASES_FOR_ALL_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    CC_MQTT311_ALIASES_FOR_ALL_MESSAGES(prefix_, suffix_, interface_, cc_mqtt311::options::DefaultOptions)
