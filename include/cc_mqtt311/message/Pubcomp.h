...
#include "cc_mqtt311/message/PubcompCommon.h"
...
/// @see @ref Pubcomp
/// @headerfile cc_mqtt311/message/Pubcomp.h
...
class Pubcomp : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<cc_mqtt311::MsgId_Pubcomp>,
...
public:
    ...
    {
        return cc_mqtt311::message::PubcompCommon::name();
    }
