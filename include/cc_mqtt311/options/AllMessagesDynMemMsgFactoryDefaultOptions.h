...
#include "cc_mqtt311/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_mqtt311::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqtt311::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
