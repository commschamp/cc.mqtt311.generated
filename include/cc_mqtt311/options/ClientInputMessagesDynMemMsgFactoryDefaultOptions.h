...
#include "cc_mqtt311/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_mqtt311::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqtt311::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
