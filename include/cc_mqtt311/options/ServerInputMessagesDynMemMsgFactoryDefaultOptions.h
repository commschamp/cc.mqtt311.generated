...
#include "cc_mqtt311/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_mqtt311::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqtt311::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
