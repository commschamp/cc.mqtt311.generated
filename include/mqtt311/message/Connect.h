...
struct ConnectFields
{
    ...
    public:
        ...
        {
            return mqtt311::message::ConnectFieldsCommon::ProtocolLevelCommon::hasSpecials();
        }
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            /// @see @ref mqtt311::message::ConnectFieldsCommon::FlagsMembersCommon::LowCommon::bitName().
        ...
        public:
            ...
            /// @brief Retrieve name of the bit.
            /// @see @ref mqtt311::message::ConnectFieldsCommon::FlagsMembersCommon::HighCommon::bitName().
            static const char* bitName(BitIdx idx)
            {
                return
    ...
    public:
        ...
        ///         for mqtt311::message::ConnectFields::FlagsMembers::Low member field.
        ///     @li @b FieldIdx_willQos index, @b Field_willQos type and @b field_willQos() access function -
        ///         for mqtt311::message::ConnectFields::FlagsMembers::WillQos member field.
        ///     @li @b FieldIdx_high index, @b Field_high type and @b field_high() access function -
        ///         for mqtt311::message::ConnectFields::FlagsMembers::High member field.
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return mqtt311::message::ConnectFieldsCommon::KeepAliveCommon::hasSpecials();
        }
